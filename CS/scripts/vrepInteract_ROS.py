...
if __name__ == "__main__":
    ...
    pub10 = rospy.Publisher("/ds_cube_sensed", String, queue_size=10) # pub setting
    productID = 8 #Change if we swap the default ID or do RFID Plan!
